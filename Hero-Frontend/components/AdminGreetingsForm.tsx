...
export default function AdminBirthdayGreetingsForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const postData = {
        id: parseInt(userId), // This is what the controller expects
        body: greetings,
        status: "processing",
        score: null,
        media: media,
  ...
  const isFormValid = greetings.trim() !== "" && userId.trim() !== "";
        ...
        <div className="p-4 sm:p-6 md:p-[32px]">
          <CardHeader className="flex flex-col items-start justify-center h-auto sm:h-[90px] pt-4 sm:pt-[44px] pb-3 px-0">
            ...
            <p className="w-full text-headingText sm:max-w-[571px] text-sm md:text-[14px] leading-normal sm:leading-[21px] text-start">
              Create posts on behalf of users. Enter the user ID and content
              below.
            </p>
          </CardHeader>
